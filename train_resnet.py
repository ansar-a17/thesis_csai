"""
train r3d 18 on ucf101 with early action sampling
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train R3D-18 on UCF101 and evaluate Top-1/Top-5 and per-class metrics."
    )
    ...
    parser.add_argument("--checkpoint_name", type=str, default="best_resnet_model.pth")
...
if __name__ == '__main__':
    ...
    print("Loading pre-trained R3D-18 (Kinetics-400)...")
